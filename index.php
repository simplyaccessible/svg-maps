<?php
    // Used pass page title into header template
    $pageHeaderAndTitle = "Example";
    // Set public_html folder as include path so we can set include path absolutely from there
    set_include_path($_SERVER['DOCUMENT_ROOT']);
    /*
     * Next variables set when to include meta tags for responsiveness and css class
     * nonresponsive is the only class that matters and locks the layout to 960px
     * for responsive you could just leave the $responsiveCssClass == ""
     * But I thought the having a class was clearer.
     *
     * Just comment one out
    */
    $responsiveCssClass = "nonresponsive";
    //$responsiveCssClass = "responsive";
?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <!-- Custom Page Title-->
        <title><?php echo $pageHeaderAndTitle ?> - Simply Accessible</title>

        <!-- Includes Global JS, CSS and META -->
        <?php include_once("template/head.php") ?>

        <!-- ADD CUSTOM SCRIPTS AND CSS BELOW HERE -->
        <link rel="stylesheet" href="stylesheets/svg-map.css">

    </head>
    <body class="<?php echo $responsiveCssClass ?>">
        <?php
            // Header template include uses $pageHeaderAndTitle to set page title
        ...
        <main class="main" id="main" role="main">
            <div class="row">
                <section>
                    <div class="inner content map_wrapper">
                        <form action="#" method="post">
                            <p>
                                <label for="state" class="visuallyhidden">Select a state</label>
                                ...
                                <button type="submit" class="link-primary"><span>Go</span></button>
                            </p>
                        </form>

                        <div id="map" class="mapsvg">
                            <svg xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:cc="http://creativecommons.org/ns#" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:svg="http://www.w3.org/2000/svg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"  version="1.1" preserveAspectRatio="xMidYMid meet" viewBox="0 0 959 593">
                                <title>Choose a State</title>

                                <!-- Washington -->
                                <g id="g-WA" class="state_taboo">
                                    ...
                                    <text class="state_default" xml:space="preserve" x="105" y="58" id="text3230">
								<tspan id="tspan3232" x="105" y="58">WA</tspan>
							</text>
                                </g>

                                <!-- Oregon -->
                                <g id="g-OR" class="state_taboo">
                                    <title>Oregon</title>
                                    <path
                                        class="state_taboo"
                                        id="OR"
                                    ...
                                    <text class="state_default" xml:space="preserve" x="80" y="128" id="text3234">
								<tspan id="tspan3236" x="90" y="128">OR</tspan>
							</text>
                                </g>

                                <!-- California -->
                                <a xlink:href="#locations-CA" xlink:title="California" class="locations">
                                    <g id="g-CA" class="state_default">
                                        ...
                                        <text class="state_default" xml:space="preserve" x="63.63961" y="298.84357" id="text3422">
								<tspan id="tspan3424" x="63.63961" y="298.84357">CA</tspan>
							</text>
                                    </g>
                                </a>

                                <!-- Nevada -->
                                <a xlink:href="#locations-NV" xlink:title="Nevada" class="locations">
                                    <g id="g-NV" class="state_default">
                                        ...
                                        <text class="state_default" xml:space="preserve" x="118.08683" y="249.3461" id="text3418">
									<tspan id="tspan3420" x="130" y="250">NV</tspan>
							</text>
                                    </g>
                                </a>

                                <!-- Idaho -->
                                <a xlink:href="#g-ID" xlink:title="Idaho">
                                    <g id="g-ID" class="state_default">
                                        ...
                                        <text class="state_default" xml:space="preserve" x="175" y="153" id="text3242">
								<tspan id="tspan3244" x="190" y="153">ID</tspan>
							</text>
                                    </g>
                                </a>

                                <!-- Utah -->
                                <a xlink:href="#g-UT" xlink:title="Utah">
                                    <g id="g-UT" class="state_default">
                                        ...
                                        <text class="state_default" xml:space="preserve" x="206.47517" y="274.09485" id="text3414">
								<tspan id="tspan3416" x="210" y="265">UT</tspan>
							</text>
                                    </g>
                                </a>

                                <!-- Arizona -->
                                <a xlink:href="#g-AZ" xlink:title="Arizona">
                                    <g id="g-AZ" class="state_default">
                                        ...
                                        <text class="state_default" xml:space="preserve" x="179.60512" y="371.67557" id="text3410">
								<tspan id="tspan3412" x="190" y="365">AZ</tspan>
							</text>
                                    </g>
                                </a>

                                <!-- Montana -->
                                <g id="g-MT" class="state_taboo">
                                    <title>Montana</title>
                                    <path
                                        class="state_taboo"
                                        id="MT"
                                    ...
                                    <text class="state_default" xml:space="preserve" x="260" y="103" id="text3238">
								<tspan id="tspan3240" x="270" y="95">MT</tspan>
							</text>
                                </g>

                                <!-- Wyoming -->
                                <a xlink:href="#g-WY" xlink:title="Wyoming">
                                    <g id="g-WY" class="state_default">
                                        ...
                                        <text class="state_default" xml:space="preserve" x="280.72141" y="188.53493" id="text3398">
								<tspan id="tspan3400" x="285" y="190">WY</tspan>
							</text>
                                    </g>
                                </a>

                                <!-- Colorado -->
                                <a xlink:href="#g-CO" xlink:title="Colorado">
                                    <g id="g-CO" class="state_default">
                                        ...
                                        <text class="state_default" xml:space="preserve" x="303.34882" y="282.58011" id="text3402">
								<tspan id="tspan3404" x="310" y="280">CO</tspan>
							</text>
                                    </g>
                                </a>

                                <!-- New Mexico -->
                                <a xlink:href="#g-NM" xlink:title="New Mexico">
                                    <g id="g-NM" class="state_default">
                                        ...
                                        <text class="state_default" xml:space="preserve" x="282.84271" y="380.16086" id="text3406">
								<tspan id="tspan3408" x="290" y="380">NM</tspan>
							</text>
                                    </g>
                                </a>

                                <!-- North Dakota -->
                                <a xlink:href="#g-ND" xlink:title="North Dakota">
                                    <g id="g-ND" class="state_default">
                                        ...
                                        <text class="state_default" xml:space="preserve" x="392.44427" y="112.16739" id="text3282">
								<tspan id="tspan3284" x="405" y="100">ND</tspan>
							</text>
                                    </g>
                                </a>

                                <!-- South Dakota -->
                                <a xlink:href="#g-SD" xlink:title="South Dakota">
                                    <g id="g-SD" class="state_default">
                                        ...
                                        <text class="state_default" xml:space="preserve" x="396.68692" y="165.9075" id="text3394">
								<tspan id="tspan3396" x="405" y="165.9075">SD</tspan>
							</text>
                                    </g>
                                </a>

                                <!-- Nebraska -->
                                <a xlink:href="#locations-NE" xlink:title="Nebraska" class="locations">
                                    <g id="g-NE" class="state_default">
                                        ...
                                        <text class="state_default" xml:space="preserve" x="403.75797" y="231.66843" id="text3390">
								<tspan id="tspan3392" x="405" y="231">NE</tspan>
							</text>
                                    </g>
                                </a>

                                <!-- Kansas -->
                                <a xlink:href="#g-KS" xlink:title="Kansas">
                                    <g id="g-KS" class="state_default">
                                        ...
                                        <text class="state_default" xml:space="preserve" x="424.97119" y="294.60095" id="text3386">
								<tspan id="tspan3388" x="424.97119" y="294.60095">KS</tspan>
							</text>
                                    </g>
                                </a>

                                <!-- Oklahoma -->
                                <a xlink:href="#g-OK" xlink:title="Oklahoma">
                                    <g id="g-OK" class="state_default">
                                        ...
                                        <text class="state_default" xml:space="preserve" x="442.64886" y="368.14005" id="text3382">
								<tspan id="tspan3384" x="450" y="365">OK</tspan>
							</text>
                                    </g>
                                </a>

                                <!-- Texas -->
                                <a xlink:href="#g-TX" xlink:title="Texas">
                                    <g id="g-TX" class="state_default">
                                        ...
                                        <text class="state_default" xml:space="preserve" x="409.41483" y="450.16443" id="text3362">
								<tspan id="tspan3364" x="409.41483" y="450.16443">TX</tspan>
							</text>
                                    </g>
                                </a>

                                <!-- Minnesota -->
                                <a xlink:href="#g-MN" xlink:title="Minnesota">
                                    <g id="g-MN" class="state_default">
                                        ...
                                        <text class="state_default" xml:space="preserve" x="491.43921" y="113.5816" id="text3286">
								<tspan id="tspan3288" x="495" y="125">MN</tspan>
							</text>
                                    </g>
                                </a>

                                <!-- Iowa -->
                                <a xlink:href="#g-IA" xlink:title="Iowa">
                                    <g id="g-IA" class="state_default">
                                        ...
                                        <text class="state_default" xml:space="preserve" x="504.16714" y="224.59737" id="text3378">
								<tspan id="tspan3380" x="515" y="220">IA</tspan>
							</text>
                                    </g>
                                </a>

                                <!-- Missouri -->
                                <a xlink:href="#g-MO" xlink:title="Missouri">
                                    <g id="g-MO" class="state_default">
                                        ...
                                        <text class="state_default" xml:space="preserve" x="521.84479" y="302.37912" id="text3374">
								<tspan id="tspan3376" x="530" y="300">MO</tspan>
							</text>
                                    </g>
                                </a>

                                <!-- Arkansas -->
                                <a xlink:href="#g-AR" xlink:title="Arkansas">
                                    <g id="g-AR" class="state_default">
                                        ...
                                        <text class="state_default" xml:space="preserve" x="532.45142" y="382.98929" id="text3370">
								<tspan id="tspan3372" x="535" y="375">AR</tspan>
							</text>
                                    </g>
                                </a>

                                <!-- Louisiana -->
                                <a xlink:href="#g-LA" xlink:title="Louisiana">
                                    <g id="g-LA" class="state_default">
                                        ...
                                        <text class="state_default" xml:space="preserve" x="537.40112" y="452.99286" id="text3366">
								<tspan id="tspan3368" x="540" y="452">LA</tspan>
							</text>
                                    </g>
                                </a>

                                <!-- Wisconsin -->
                                <a xlink:href="#g-WI" xlink:title="Wisconsin">
                                    <g id="g-WI" class="state_default">
                                        ...
                                        <text class="state_default" xml:space="preserve" x="558.61438" y="160.95776" id="text3290">
								<tspan id="tspan3292" x="570" y="160">WI</tspan>
							</text>
                                    </g>
                                </a>

                                <!-- Illinois -->
                                <a xlink:href="#g-IL" xlink:title="Illinois">
                                    <g id="g-IL" class="state_default">
                                        ...
                                        <text class="state_default" xml:space="preserve" x="579.82758" y="265.60956" id="text3318">
								<tspan id="tspan3320" x="590" y="265">IL</tspan>
							</text>
                                    </g>
                                </a>

                                <!-- Mississippi -->
                                <a xlink:href="#g-MS" xlink:title="Mississippi">
                                    <g id="g-MS" class="state_default">
                                        ...
                                        <text class="state_default" xml:space="preserve" x="590" y="423" id="text3358">
								<tspan id="tspan3360" x="590" y="423">MS</tspan>
							</text>
                                    </g>
                                </a>

                                <!-- Michigan -->
                                <a xlink:href="#g-MI" xlink:title="Michigan">
                                    <g id="g-MI" class="state_default">
                                        <title>Michigan</title>
                                        <g id="MI" class="state_default">
                                            <path
                                                id="MI-"
                                                class="state_default"
                                        ...
                                        <text class="state_default" xml:space="preserve" x="648.41693" y="191.36336" id="text3294">
								<tspan id="tspan3296" x="655" y="190">MI</tspan>
							</text>
                                    </g>
                                </a>

                                <!-- Indiana -->
                                <a xlink:href="#g-IN" xlink:title="Indiana">
                                    <g id="g-IN" class="state_default">
                                        ...
                                        <text class="state_default" xml:space="preserve" x="631.44635" y="262.07404" id="text3314">
								<tspan id="tspan3316" x="640" y="260">IN</tspan>
							</text>
                                    </g>
                                </a>

                                <!-- Ohio -->
                                <a xlink:href="link-oh" xlink:title="Show stuff for Ohio">
                                    <g id="g-OH" class="state_default">
                                        ...
                                        <text class="state_default" xml:space="preserve" x="678.11542" y="250.76031" id="text3310">
								<tspan id="tspan3312" x="690" y="245">OH</tspan>
							</text>
                                    </g>
                                </a>

                                <!-- Kentucky -->
                                <a xlink:href="#g-KY" xlink:title="Kentucky">
                                    <g id="g-KY" class="state_default">
                                        ...
                                        <text class="state_default" xml:space="preserve" x="658.31641" y="309.45016" id="text3322">
								<tspan id="tspan3324" x="658.31641" y="309.45016">KY</tspan>
							</text>
                                    </g>
                                </a>

                                <!-- Tennessee -->
                                <a xlink:href="#g-TN" xlink:title="Tennessee">
                                    <g id="g-TN" class="state_default">
                                        ...
                                        <text class="state_default" xml:space="preserve" x="629.32501" y="349.75528" id="text3354">
								<tspan id="tspan3356" x="640" y="345">TN</tspan>
							</text>
                                    </g>
                                </a>

                                <!-- Alabama -->
                                <a xlink:href="#g-AL" xlink:title="Alabama">
                                    <g id="g-AL" class="state_default">
                                        ...
                                        <text class="state_default" xml:space="preserve" x="639.93164" y="426.8299" id="text3350">
								<tspan id="tspan3352" x="645" y="415">AL</tspan>
							</text>
                                    </g>
                                </a>

                                <!-- New York -->
                                <a xlink:href="#g-NY" xlink:title="New York">
                                    <g id="g-NY" class="state_default">
                                        ...
                                        <text class="state_default" xml:space="preserve" x="802.56622" y="160.95776" id="text3302">
								<tspan id="tspan3304" x="802.56622" y="160.95776">NY</tspan>
							</text>
                                    </g>
                                </a>

                                <!-- Pennsylvania -->
                                <a xlink:href="#g-PA" xlink:title="Pennsylvania">
                                    <g id="g-PA" class="state_default">
                                        ...
                                        <text class="state_default" xml:space="preserve" x="759.43268" y="219.64761" id="text3306">
								<tspan id="tspan3308" x="770" y="215">PA</tspan>
							</text>
                                    </g>
                                </a>

                                <!-- West Virginia -->
                                <a xlink:href="#g-WV" xlink:title="West Virginia">
                                    <g id="g-WV" class="state_default">
                                        ...
                                        <text class="state_default" xml:space="preserve" x="729.0271" y="273.38773" id="text3326">
								<tspan id="tspan3328" x="729.0271" y="273.38773">WV</tspan>
							</text>
                                    </g>
                                </a>

                                <!-- Georgia -->
                                <a xlink:href="#g-GA" xlink:title="Georgia">
                                    <g id="g-GA" class="state_default">
                                        ...
                                        <text class="state_default" xml:space="preserve" x="703.57123" y="422.58728" id="text3342">
								<tspan id="tspan3344" x="705" y="410">GA</tspan>
							</text>
                                    </g>
                                </a>

                                <!-- Florida -->
                                <a xlink:href="#g-FL" xlink:title="Florida">
                                    <g id="g-FL" class="state_default">
                                        ...
                                        <text class="state_default" xml:space="preserve" x="756.60425" y="506.02588" id="text3346">
									<tspan id="tspan3348" x="760" y="500">FL</tspan>
							</text>
                                    </g>
                                </a>

                                <!-- Maine -->
                                <a xlink:href="#g-ME" xlink:title="Maine">
                                    <g id="g-ME" class="state_default">
                                        ...
                                        <text class="state_default" xml:space="preserve" x="877.51953" y="91.661293" id="text3298">
								<tspan id="tspan3300" x="877.51953" y="91.661293">ME</tspan>
							</text>
                                    </g>
                                </a>

                                <!-- New Hampshire -->
                                <a xlink:href="#g-NH" xlink:title="New Hampshire">
                                    <g id="g-NH" class="state_default">
                                        ...
                                        <rect class="state_default" id="NH1" width="40" height="31" x="895" y="193">
                                        </rect>
                                        <text class="state_default" xml:space="preserve" x="897.82843" y="218" id="text3246">
									<tspan id="tspan3248" x="904" y="215">NH</tspan>
							 </text>
                                    </g>
                                </a>

                                <!-- Vermont -->
                                <a xlink:href="#locations-VT" xlink:title="Vermont" class="locations">
                                    <g id="g-VT" class="state_default">
                                        ...
                                        <rect class="state_default" y="228" x="895" width="40" height="31" id="VT1"/>
                                        <text class="state_default" xml:space="preserve" x="900" y="253" id="text3250">
								<tspan id="tspan3252" x="905" y="250">VT</tspan>
							</text>
                                    </g>
                                </a>

                                <!-- Massachusetts -->
                                <a xlink:href="#g-MA" xlink:title="Massachusetts">
                                    <g id="g-MA" class="state_default">
                                        ...
                                        <rect class="state_default" id="MA1" width="40" height="31" x="895" y="263"/>
                                        <text class="state_default" xml:space="preserve" x="898.05548" y="288" id="text3254">
								<tspan id="tspan3256" x="903" y="285">MA</tspan>
							</text>
                                    </g>
                                </a>

                                <!-- Connecticut -->
                                <a xlink:href="#g-CT" xlink:title="Connecticut">
                                    <g id="g-CT" class="state_default">
                                        ...
                                        <rect class="state_default" y="298" x="895" width="40" height="31" id="CT1"/>
                                        <text class="state_default" xml:space="preserve" x="900" y="323" id="text3258">
								<tspan id="tspan3260" x="904" y="320">CT</tspan>
							</text>
                                    </g>
                                </a>

                                <!-- Rhode Island -->
                                <a xlink:href="#g-RI" xlink:title="Rhode Island">
                                    <g id="g-RI" class="state_default">
                                        ...
                                        <rect class="state_default" id="RI1" width="40" height="31" x="895" y="333"/>
                                        <text class="state_default" xml:space="preserve" x="902.77563" y="358" id="text3262">
								<tspan id="tspan3264" x="907" y="355">RI</tspan>
							</text>
                                    </g>
                                </a>

                                <!-- New Jersey -->
                                <a xlink:href="#g-NJ" xlink:title="New Jersey">
                                    <g id="g-NJ" class="state_default">
                                        ...
                                        <rect class="state_default" y="368" x="895" width="40" height="31" id="NJ1"/>
                                        <text class="state_default" xml:space="preserve" x="897.67206" y="393" id="text3266">
								<tspan id="tspan3268" x="904" y="390">NJ</tspan>
							</text>
                                    </g>
                                </a>

                                <!-- Delaware -->
                                <a xlink:href="#g-DE" xlink:title="Delaware">
                                    <g id="g-DE" class="state_default">
                                        ...
                                        <rect class="state_default" id="DE1" width="40" height="31" x="895" y="403"/>
                                        <text class="state_default" xml:space="preserve" x="897.67206" y="428" id="text3270">
								<tspan id="tspan3272" x="903" y="425">DE</tspan>
							</text>
                                    </g>
                                </a>

                                <!-- Maryland -->
                                <a xlink:href="#g-MD" xlink:title="Maryland">
                                    <g id="g-MD" class="state_default">
                                        ...
                                        <rect class="state_default" y="438" x="895" width="40" height="31" id="MD1"/>
                                        <text class="state_default" xml:space="preserve" x="900" y="460" id="text3274">
								<tspan id="tspan3276" x="903" y="460">MD</tspan>
							</text>
                                    </g>
                                </a>

                                <!-- Washington DC -->
                                <a xlink:href="#g-DC" xlink:title="Washington DC">
                                    <g id="g-DC" class="state_default">
                                        ...
                                        <rect class="state_default" id="DC1" width="40" height="31" x="895" y="473"/>
                                        <text class="state_default" xml:space="preserve" x="903.15063" y="498" id="text3278">
								<tspan id="tspan3280" x="905.15063" y="495">DC</tspan>
							</text>
                                    </g>
                                </a>

                                <!-- Virginia -->
                                <a xlink:href="#g-VA" xlink:title="Virginia">
                                    <g id="g-VA" class="state_default">
                                        ...
                                        <text class="state_default" xml:space="preserve" x="772.16058" y="291.0654" id="text3330">
								<tspan id="tspan3332" x="780" y="285">VA</tspan>
							</text>
                                    </g>
                                </a>

                                <!-- North Carolina -->
                                <a xlink:href="#g-NC" xlink:title="North Carolina">
                                    <g id="g-NC" class="state_default">
                                        ...
                                        <text class="state_default" xml:space="preserve" x="769.33215" y="332.07761" id="text3334">
								<tspan id="tspan3336" x="769.33215" y="332.07761">NC</tspan>
							</text>
                                    </g>
                                </a>

                                <!-- South Carolina -->
                                <a xlink:href="#g-SC" xlink:title="South Carolina">
                                    <g id="g-SC" class="state_default">
                                        ...
                                        <text class="state_default" xml:space="preserve" x="750.94739" y="374.504" id="text3338">
								<tspan id="tspan3340" x="750.94739" y="374.504">SC</tspan>
							</text>
                                    </g>
                                </a>

                                <!-- Alaska -->
                                <a xlink:href="#g-AK" xlink:title="Alaska">
                                    <g id="g-AK" class="state_default">
                                        ...
                                        <text class="state_default" xml:space="preserve" x="106.77312" y="498.24768" id="text3426" >
									<tspan id="tspan3428" x="106.77312" y="498.24768">AK</tspan>
								</text>
                                    </g>
                                </a>

                                <!-- Hawaii -->
                                <a xlink:href="#g-HI" xlink:title="Hawaii">
                                    <g id="g-HI" class="state_default">
                                        ...
                                        <path
                                            ...
                                            id="HI" />
                                        <text class="state_default" id="hi-label" y="560.47308" x="267.28635" xml:space="preserve">
									<tspan x="295" y="570" id="tspan3432">HI</tspan>
								</text>
                                    </g>
                                </a>

                                <!-- Puerto Rico -->
                                <a xlink:href="#g-PR" xlink:title="Puerto Rico">
                                    <g id="g-PR" class="state_default">
                                        <title>Puerto Rico</title>
                                        <path
                                            class="state_default"
                                            d="m 849.60191,578.71532 c 0,-0.0914 0,-0.18272 0,-0.27408 0,-0.0642 0.0237,-0.61042 0,-0.65781 -0.0116,-0.0231 -0.0433,-0.0317 -0.0548,-0.0548 -0.008,-0.0163 0.0129,-0.0419 0,-0.0548 -0.0129,-0.0129 -0.0419,0.0129 -0.0548,0 -0.0129,-0.0129 0.006,-0.0375 0,-0.0548 -0.008,-0.0227 -0.14959,-0.25923 -0.16445,-0.27409 -0.0129,-0.0129 -0.0385,0.008 -0.0548,0 -0.22814,-0.11407 0.0586,0.004 -0.0548,-0.10963 -0.0289,-0.0289 -0.0756,-0.0322 -0.10964,-0.0548 -0.0215,-0.0143 -0.0317,-0.0433 -0.0548,-0.0548 -0.0163,-0.008 -0.0419,0.0129 -0.0548,0 -0.0129,-0.0129 0.0129,-0.0419 0,-0.0548 -0.0129,-0.0129 -0.0548,-0.0183 -0.0548,0 0,0.0258 0.0548,0.0806 0.0548,0.0548 0,-0.27692 -0.0421,-0.0842 -0.10964,-0.21927 -0.007,-0.0145 -0.003,-0.3733 0,-0.38372 0.008,-0.0245 0.0466,-0.0303 0.0548,-0.0548 0.0116,-0.0347 -0.0115,-0.075 0,-0.10964 0.008,-0.0245 0.0466,-0.0303 0.0548,-0.0548 0.0173,-0.052 -0.0388,-0.12569 0,-0.16445 0.0129,-0.0129 0.0419,0.0129 0.0548,0 0.0129,-0.0129 -0.006,-0.0375 0,-0.0548 0.0129,-0.0388 0.0419,-0.0709 0.0548,-0.10964 0.006,-0.0173 -0.0129,-0.0419 0,-0.0548 0.0129,-0.0129 0.0466,0.0164 0.0548,0 0.0163,-0.0327 -0.0163,-0.0769 0,-0.10963 0.008,-0.0163 0.0419,0.0129 0.0548,0 0.0289,-0.0289 0.0419,-0.0709 0.0548,-0.10964 0.006,-0.0173 -0.0129,-0.0419 0,-0.0548 0.0129,-0.0129 0.0419,0.0129 0.0548,0 0.0258,-0.0258 -0.0115,-0.075 0,-0.10964 0.0377,-0.11317 0.11827,-0.12689 0.16445,-0.21927 0.008,-0.0163 -0.0129,-0.0419 0,-0.0548 0.0986,-0.0986 0.16245,-0.0269 0.27409,-0.0548 0.0396,-0.01 0.07,-0.0449 0.10964,-0.0548 0.0355,-0.009 0.0769,0.0163 0.10963,0 0.0163,-0.008 0,-0.0365 0,-0.0548 0.0365,-0.0183 0.0709,-0.0419 0.10963